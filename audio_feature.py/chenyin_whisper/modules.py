...
# from .clip_vit import ResidualAttentionBlock as CLIPResidualAttentionBlock
...
# class ResidualAttentionBlock(CLIPResidualAttentionBlock):
#     def __init__(self,  d_model: int, n_head: int, attn_mask: torch.Tensor = None, drop_path=0.):
#         super().__init__(d_model, n_head, attn_mask, drop_path)
