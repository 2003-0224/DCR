...
def main():
    ...
    # 重采样
    base_save_dir = "/data2/home/chenqian/checkpoints/reSample"
    ...
    for seed in seeds:
        ...
        class_weights = 1.0 / np.maximum(class_counts, 1)  # 防止除零
        # 为每个样本分配权重
        sample_weights = class_weights[train_labels]
        # 将 NumPy 数组转换为 PyTorch Tensor (WeightedRandomSampler需要)
        ...
        train_loader = DataLoader(train_dataset, batch_size=batch_size, sampler=sampler, shuffle=False, num_workers=4)
